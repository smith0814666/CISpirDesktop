...
| Mac（不确定芯片） | 通用 | [CISpir-1.4.5-universal.dmg](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-1.4.5-universal.dmg) |
...
| Windows（ARM：骁龙 / Copilot+ PC） | arm64 | [CISpir-Setup-1.4.5-arm64.exe](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-Setup-1.4.5-arm64.exe) |
