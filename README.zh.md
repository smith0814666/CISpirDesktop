...
| Mac（不确定芯片） | 通用 | [CISpir-1.4.2-universal.dmg](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.2/CISpir-1.4.2-universal.dmg) |
...
| Windows（ARM：骁龙 / Copilot+ PC） | arm64 | [CISpir-Setup-1.4.2-arm64.exe](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.2/CISpir-Setup-1.4.2-arm64.exe) |
