...
|---|---|---|
| Mac (Apple M1 / M2 / M3 / M4) | Apple Silicon (arm64) | [CISpir-1.4.5-arm64.dmg](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-1.4.5-arm64.dmg) |
| Mac (Intel) | Intel (x64) | [CISpir-1.4.5-x64.dmg](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-1.4.5-x64.dmg) |
| Mac (not sure which chip) | Universal | [CISpir-1.4.5-universal.dmg](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-1.4.5-universal.dmg) |
| Windows (Intel / AMD) | x64 | [CISpir-Setup-1.4.5-x64.exe](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-Setup-1.4.5-x64.exe) |
| Windows (ARM: Snapdragon / Copilot+ PC) | arm64 | [CISpir-Setup-1.4.5-arm64.exe](https://github.com/smith0814666/CISpirDesktop/releases/download/v1.4.5/CISpir-Setup-1.4.5-arm64.exe) |
